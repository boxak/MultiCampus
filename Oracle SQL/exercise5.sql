...
SELECT E.ENAME "직원이름", D.DNAME "부서명", TO_CHAR(E.SAL,'999,999') "월급"
...
SELECT E.EMPNO "직원번호", E.ENAME "직원이름", 12*E.SAL "연봉", 12*E.SAL+E.COMM "실급여"
, S.GRADE "급여등급"
...
SELECT E1.EMPNO "사원번호",E1.ENAME "사원이름",NVL(TO_CHAR(E1.MGR),'없음') "관리자번호",NVL(E2.ENAME,'없음') "관리자이름"
