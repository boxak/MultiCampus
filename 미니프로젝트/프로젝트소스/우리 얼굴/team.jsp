			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate" style = "margin : auto;">
						<div class="staff border">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(/javas/resources/images/captain2.jpg);"></div>
							</div>
					...
					<div class="col-md-6 col-lg-3 ftco-animate" style = "margin : auto;">
						<div class="staff border">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(/javas/resources/images/antman2.jpg);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center" >
								<h3>황지원</h3>
					...
					<div class="col-md-6 col-lg-3 ftco-animate" style = "margin : auto;">
						<div class="staff border">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url(/javas/resources/images/spiderman2.jpg);"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>정해림</h3>
