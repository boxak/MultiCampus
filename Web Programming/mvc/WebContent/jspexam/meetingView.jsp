<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%> 
    <%@ page import="model.vo.MeetingVO,java.util.ArrayList,java.util.List"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
%>
	...
	<tr>
		...
		<td><button onclick="location.href='/mvc/meeting?delete=<%= vo.getId() %>'"><img src="https://image.flaticon.com/icons/png/512/1966/1966368.png"></button>
		</td>
	</tr>
	<% } %>
