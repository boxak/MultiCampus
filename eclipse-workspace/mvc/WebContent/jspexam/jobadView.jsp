<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="model.vo.JobadVO,java.util.List" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
%>
	<tr>
		...
		<th><a href="/mvc/jobad?action=listWriter&mem_username=<%= vo1.getMem_username() %>"><%= vo1.getMem_username() %></a></th>
		<th>
		<a href="/mvc/jobad?action=listone&post_id=<%= vo1.getPost_id() %>"><%= vo1.getPost_title() %></a>
		</th>
...
%>
<button onclick="location.href='/mvc/jspexam/jobadInsertForm.jsp'">새 글 작성</button>
<button onclick="location.href='/mvc/jobad'">첫 화면으로 가기</button>
<form action="/mvc/jobad" method="get">
...
<div>
	...
	<button onclick="location.href='/mvc/jobad?action=delete&post_id=<%= vo.getPost_id() %>'">글 삭제하기</button>
	<button onclick="location.href='/mvc/jspexam/jobadUpdateForm.jsp'">글 수정하기</button>
</div>
<%
}
%>
