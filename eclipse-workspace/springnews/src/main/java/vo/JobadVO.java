...
public class JobadVO {
	...
	public String toString() {
		return "JobadVO [post_id=" + post_id + ", mem_userid=" + mem_userid + ", mem_username=" + mem_username
				+ ", post_title=" + post_title + ", post_content=" + post_content + ", post_writedate=" + post_writedate
				+ ", post_hit=" + post_hit + ", post_location=" + post_location + ", post_payment=" + post_payment
				+ ", post_phone=" + post_phone + ", post_review_count=" + post_review_count + "]";
	}
